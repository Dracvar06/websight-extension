...
(() => {
  ...
  function scrollInfo() {
    ...
    return `SCROLL POSITION: the visible screenshot covers ${top}% to ${bottom}% of a page about ${screens} screens tall. The PAGE TEXT below includes content beyond the visible part.`;
  }
